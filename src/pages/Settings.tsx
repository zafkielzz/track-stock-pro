  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Manage application and account settings</p>
      </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Notifications for products nearing expiry</div>
                </div>
                <Switch defaultChecked />
              </div>
              <Separator />
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Notifications for stock in/out operations</div>
                </div>
                <Switch defaultChecked />
              </div>
              <Separator />
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Enable daily database backups</div>
                </div>
                <Switch defaultChecked />
              </div>
              <Separator />
